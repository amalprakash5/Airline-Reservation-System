...
class APAirlines extends JFrame implements ActionListener{
    ...
    APAirlines()
    {
        ...
        JLabel l4= new JLabel("Contact us at 124003025@sastra.ac.in");
        l4.setFont(new Font("Verdana", Font.PLAIN, 12));
        l4.setBounds(645,10,300,20);
...
class BookTicket extends JFrame implements ActionListener
{
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource()==b4)
        {
            ...
            {
                JLabel label = new JLabel("Passenger details are insufficient.");
                label.setFont(new Font("Verdana", Font.PLAIN, 12));
                //passengerMismatch
                JOptionPane.showMessageDialog(null,label,"Fail",JOptionPane.ERROR_MESSAGE);
            }
            ...
            {
                JLabel label = new JLabel("Age is incorrectly entered.");
                label.setFont(new Font("Verdana", Font.PLAIN, 12));
                //AgeWronglySpecified
                JOptionPane.showMessageDialog(null,label,"Fail",JOptionPane.ERROR_MESSAGE);
            }
